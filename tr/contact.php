        ...
        <section class="content">
            ...
            <div class="contact-det">
                ...
                <form id="contact-us-form" method="post" action="">
                    <input type="text" size="30" name="name" value="" placeholder="isim" required />
                    <input type="email" size="30" name="email" value="" placeholder="E-posta" required />
                    <input type="text" size="30" name="subject" value="" placeholder="tabi"/>
                    <textarea name="msg" placeholder="mesaj"></textarea>
                    <button name="submitcontact" value="">Gönder</button>
                </form>
                <?php
                if (isset($_POST['submitcontact'])) {
                    ...
                    if ($sendmail){
                        echo '<div class="success">Sen başarıyla teşekkür gönder</div>';
                    }else{
                        echo '<div class="err">Yok gönderme hata var, lütfen tekrar deneyin</div>';
                    }
                }
                ?>
            </div>
