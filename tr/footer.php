        ...
        <footer>
            ...
            <div class="row-h">
                <form id="mailing-list-form" method="post" action="">
                    <input type="email" name="email" value="" placeholder="Bizim e-posta listesine kaydınızı yaptırın ve son alıyorsunuz" />
                    <button name="submitmailing" value="">Abonelik</button>
                </form>
                <?php
                    if (isset($_POST['submitmailing'])) {
                        if (!empty($_POST['email'])) {
                                ...
                                if ($sendmail){
                                    echo '<div class="success">Sen başarıyla teşekkür gönderin</div>';
                                }else{
                                    echo '<div class="err">Yok verici hatası var, lütfen tekrar deneyin</div>';
                                }
                        }else{
                            echo '<div class="err">Yok verici hatası var, lütfen tekrar deneyin</div>';
                        }
                    ...
                    $('.apply').click(function(){
                        ...
                        if($('#app_pub').css('display') == 'none'){
                            ...
                            if($('#app_pub form').length == 0){
                                $('#app_pub').append('<form method="post" action="include/reg_show.php" accept-charset="utf-8"><input type="text"  name="name"  placeholder="isim"   required/><input type="text"  name="tele"  placeholder="telefon" required/><input type="email" name="email" placeholder="E-posta" required/><button name="submit">Gönder</button></form>');
                            }
    ...
    <div id="add_ads" style="display:none;">
        ...
        <form id="add-ad-form" name="add-ad-form" method="post" action="include/add_ads.php"  enctype="multipart/form-data" accept-charset="utf-8">
            <div id="step_1">
                <table>
                    <tr>
                        ...
                        <td class="inp" colspan="2"><input id="name" class="inputtxt" type="text" name="name" value="" placeholder="isim" required /></td>
                    </tr>
                    <tr>
                        <td class="star"><label for="co_name">*</label></td>
                        <td class="inp" colspan="2"><input id="co_name" class="inputtxt" type="text" name="co_name" value="" placeholder="şirket" required /></td>
                    </tr>
                    <tr>
                        <td class="star"><label for="tel">*</label></td>
                        <td class="inp" colspan="2"><input id="tel" class="inputtxt" type="text" name="tel" value="" placeholder="telefon" required /></td>
                    </tr>
                    <tr>
                        <td class="star"><label for="email">*</label></td>
                        <td class="inp" colspan="2"><input id="email" class="inputtxt" type="email" name="email" value="" placeholder="E-posta" required /></td>
                    </tr>
                    <tr>
                        <td class="star"></td>
                    ...
                    <tr>
                        <td class="star"></td>
                        <td class="inp" colspan="2"><textarea id="txt" name="txt" placeholder="Reklam Bilgileri"></textarea></td>
                    </tr>
                        <?php
            ...
            <div class="clear"></div>
            <button id="submit-ads" name="submit-ads" value="">Gönder</button>
        </form>
    </div>
    <!--end  add_ads -->
    <!--start classified -->
    <div id="classified" style="display:none;"> 
        ...
        <h1>Seri ilanlar Ücretsizdir</h1>
        <form method="post" action="include/classified.php">
            <input id="tel" type="text"  name="tel" placeholder="telefon" />
            <input id="email" type="email" name="email" placeholder="E-posta" />
            <input id="region" type="text" name="region" placeholder="bölgenin" />
            <select name="type" id="type">
                <option value="" selected="selected">Reklam Türü Seçin</option>
                <?php
            ...
            <textarea id="textad" name="textad" maxlength="200" placeholder="Reklam Metni"></textarea>
            <button id="classified_btn" name="classified_btn">Gönder</button>
        </form>
    </div>
<!--start -->
    ...
    if(isset($_GET["msg"])){
        if($_GET["msg"] == 1){
            echo '<div id="done"> başarıyla Yapıldı </div>';
            echo '<meta http-equiv="refresh" content="5;URL='.$_SERVER["PHP_SELF"].'" />';
         }elseif($_GET["msg"] == 2){ 
            echo'<div id="error"> Lütfen deneyin bir sorun var </div>';
            echo '<meta http-equiv="refresh" content="5;URL='.$_SERVER["PHP_SELF"].'" />'; 
        }
    } 
    ?>
