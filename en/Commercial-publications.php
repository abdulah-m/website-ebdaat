...
<section class="content">
    <section id="portfolio">
        ...
        <ul class="portfolio-filter text-center">
            <li><a class="btn btn-default active" href="#" data-filter="*">All publications</a></li>
            <?php
                        ...
                        <div class="recent-work-wrap">
                            ...
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    ...
                                    <a class="preview" href="../images/publications/full/'.$image.'" rel="prettyPhoto"><i class="fa fa-eye"></i> Show </a>
                                </div> 
                            </div>
                        </div>
                    </div><!--/.portfolio-item-->';
