...
<section class="content">
    <section id="portfolio">
        ...
        <ul class="portfolio-filter text-center">
            <li><a class="btn btn-default active" href="#" data-filter="*">كل المطبوعات</a></li>
            <?php
                        ...
                        <div class="recent-work-wrap">
                            ...
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    ...
                                    <a class="preview" href="../images/publications/full/'.$image.'" rel="prettyPhoto"><i class="fa fa-eye"></i> عرض </a>
                                </div> 
                            </div>
                        </div>
                    </div><!--/.portfolio-item-->';
...
<div id="publ_form" style="display:none;">
    ...
    <form id="publ_form2" action="include/publ_form.php" method="post">
        ...
        <select name="faces" id="faces">
            ...
            <?php
            $faces = array("وجه واحد","وجهين","وجه واحد ملون","وجهين ملونين");
            $i = 0;
            while($i < count($faces)){
                $i++;
